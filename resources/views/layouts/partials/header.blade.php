<header id="header" class="{{ $headerClass ?? 'header-v1' }}">
    ...
    <div class="header-top-banner">
        <a href="{{ url('/shop') }}"><img src="{{ asset('img/banner-top.png') }}" alt="" class="img-reponsive"></a>
    </div>
                    ...
                    <li class="level1 dropdown" style="flex:1;text-align:center;">
                        ...
                        <ul class="dropdown-menu hb-shop-dropdown" style="min-width:600px;left:50%;transform:translateX(-50%);padding:14px 20px;border:none;box-shadow:0 4px 18px rgba(0,0,0,0.12);border-radius:4px;margin-top:0;">
                            <li style="display:inline-block;padding:6px 14px;">
                                <a href="{{ url('/shop') }}?category=Smart+Watches" style="color:#00a0a0;font-size:12px;font-weight:700;text-transform:uppercase;white-space:nowrap;text-decoration:none;">Smart Watches</a>
                            </li>
                            <li style="display:inline-block;padding:6px 14px;">
                                <a href="{{ url('/shop') }}?category=Games" style="color:#ff6b35;font-size:12px;font-weight:700;text-transform:uppercase;white-space:nowrap;text-decoration:none;">Games</a>
                            </li>
                            <li style="display:inline-block;padding:6px 14px;">
                                <a href="{{ url('/shop') }}?category=Airbuds" style="color:#00a0a0;font-size:12px;font-weight:700;text-transform:uppercase;white-space:nowrap;text-decoration:none;">Airbuds</a>
                            </li>
                            <li style="display:inline-block;padding:6px 14px;">
                                <a href="{{ url('/shop') }}?category=Cables" style="color:#ff6b35;font-size:12px;font-weight:700;text-transform:uppercase;white-space:nowrap;text-decoration:none;">Cables</a>
                            </li>
                            <li style="display:inline-block;padding:6px 14px;">
                                <a href="{{ url('/shop') }}?category=Projector" style="color:#00a0a0;font-size:12px;font-weight:700;text-transform:uppercase;white-space:nowrap;text-decoration:none;">Projector</a>
                            </li>
                            <li style="display:inline-block;padding:6px 14px;">
                                <a href="{{ url('/shop') }}?category=Charger" style="color:#ff6b35;font-size:12px;font-weight:700;text-transform:uppercase;white-space:nowrap;text-decoration:none;">Charger</a>
                            </li>
                            <li style="display:inline-block;padding:6px 14px;">
                                <a href="{{ url('/shop') }}?category=Cooling+Fan" style="color:#00a0a0;font-size:12px;font-weight:700;text-transform:uppercase;white-space:nowrap;text-decoration:none;">Cooling Fan</a>
                            </li>
                        </ul>
                    </li>
                    <li class="level1" style="flex:1;text-align:center;">
            ...
            <nav class="hb-nav-right" style="display:flex;align-items:stretch;background:linear-gradient(to right,#a855f7,#06b6d4);flex-shrink:0;transform:skewX(-12deg);transform-origin:bottom left;margin-left:-18px;">
                <ul class="nav navbar-nav hb-menu-right" style="display:flex;align-items:stretch;margin:0;padding:0;flex-wrap:nowrap;list-style:none;transform:skewX(12deg);">
                    <li class="level1" style="display:flex;align-items:center;border-right:1px solid rgba(255,255,255,0.35);">
                        <a href="{{ url('/flash-deals') }}" style="padding:22px 22px;display:flex;align-items:center;color:#fff;font-size:14px;font-weight:600;white-space:nowrap;text-decoration:none;">Flash Deals</a>
                    </li>
                    <li class="level1" style="display:flex;align-items:center;border-right:1px solid rgba(255,255,255,0.35);position:relative;">
                        <a href="{{ url('/tech-discovery') }}" style="padding:22px 22px;display:flex;align-items:center;color:#fff;font-size:14px;font-weight:600;white-space:nowrap;text-decoration:none;">Tech Discovery</a>
                    ...
                    <li class="level1" style="display:flex;align-items:center;border-right:1px solid rgba(255,255,255,0.35);">
                        <a href="{{ url('/trending-styles') }}" style="padding:22px 22px;display:flex;align-items:center;color:#fff;font-size:14px;font-weight:600;white-space:nowrap;text-decoration:none;">Trending Styles</a>
                    </li>
                    <li class="level1" style="display:flex;align-items:center;">
                        <a href="{{ url('/gift-cards') }}" style="padding:22px 22px;display:flex;align-items:center;color:#fff;font-size:14px;font-weight:600;white-space:nowrap;text-decoration:none;">Gift Cards</a>
                    </li>
                </ul>
            </nav>
