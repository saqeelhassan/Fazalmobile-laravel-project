@php
    ...
    $ecatFeatured   = $eCatFeatured   ?? Product::where('status', 'active')->where('is_featured', true)->latest()->take(3)->get();
    $ecatOnSale     = $eCatOnSale     ?? Product::where('status', 'active')->where('is_on_sale', true)->latest()->take(3)->get();
    $ecatTopSelling = $eCatTopSelling ?? Product::where('status', 'active')->withCount('orderItems')->orderByDesc('order_items_count')->take(3)->get();
@endphp
