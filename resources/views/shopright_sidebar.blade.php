                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            @foreach($sortLabels as $key => $label)
                                                <li><a href="{{ url('/shop-right-sidebar') }}?{{ http_build_query(array_merge(request()->query(), ['sort' => $key])) }}">{{ $label }}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            @foreach([12, 24, 36, 48] as $n)
                                                <li><a href="{{ url('/shop-right-sidebar') }}?{{ http_build_query(array_merge(request()->query(), ['per_page' => $n])) }}">{{ $n }}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
