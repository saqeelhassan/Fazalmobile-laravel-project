@php
    $pageTitle    = 'My Returns — Fazal Mobiles';
    $currentPage  = 'shop';
            ...
            <div class="myaccount">
                ...
                <div class="row" style="margin:0 -15px">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12" style="padding:0 15px;margin-bottom:25px">
                        @include('layouts.partials.account_sidebar', ['u' => $u, 'active' => 'returns'])
                    </div>

                    {{-- Main content --}}
                    <div class="col-md-9 col-sm-8 col-xs-12" style="padding:0 15px">
                        <h1 style="font-size:24px;font-weight:600;margin:0 0 20px">My Returns</h1>

                        <div style="background:#fff;border:1px solid #eee;border-radius:8px;padding:22px">
                            @include('layouts.partials.orders_table', ['orders' => $orders, 'emptyMessage' => "You haven't returned any products yet."])
                        </div>
                    </div>
                </div>
            </div>
